...
const GOLF_COURSES = [
  ...
  { id:"logebien",  name:"로제비앙GC 곤지암",  zone:"수도권", region:"경기 광주", addr:"광주시 곤지암읍 오향길 180", lat:37.35, lon:127.29 },
  ...
  { id:"seowonhills",name:"서원힐스CC",        zone:"수도권", region:"경기 파주", addr:"파주시 광탄면 서원길 333", lat:37.78, lon:126.89 },
